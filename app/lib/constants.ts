...
export const TRANSLATIONS = {
  en: {
    ...
    description:
      "In this interactive simulation, you will act as a coach and guide a virtual coachee through realistic conversations using proven coaching frameworks:",
    growModel:
      "GROW – Goal, Reality, Options, Will do – for structured coaching conversations",
    coacheeDescription:
      "The coachee will respond naturally—sometimes confident, sometimes uncertain, and occasionally challenged. Your task is to stay curious, ask open questions, and support reflection, clarity, and growth.",
  ...
  nl: {
    ...
    description:
      "In deze interactieve simulatie ga je optreden als coach en een virtuele coachee begeleiden door realistische gesprekken met bewezen coaching-frameworks:",
    growModel:
      "GROW – Doel, Realiteit, Opties, Wil – voor gestructureerde coaching-gesprekken",
    coacheeDescription:
      "De coachee zal natuurlijk reageren – soms zelfverzekerd, soms onzeker en af en toe uitgedaagd. Je taak is om nieuwsgierig te blijven, open vragen te stellen en reflectie, duidelijkheid en groei te ondersteunen.",
